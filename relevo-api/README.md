...
To update the database use this command from the Web project folder (replace `Relevo` with your project's name):

```powershell
dotnet ef database update -c AppDbContext -p ../Relevo.Infrastructure/Relevo.Infrastructure.csproj -s Relevo.Web.csproj
```
