...
-- Tabla HANDOVER_CONFIRMATION_CHECKLISTS (listas de verificación para síntesis)
CREATE TABLE HANDOVER_CONFIRMATION_CHECKLISTS (
    ID VARCHAR2(50) PRIMARY KEY,
    HANDOVER_ID VARCHAR2(50) NOT NULL,
    USER_ID VARCHAR2(255) NOT NULL,
    ...
    CREATED_AT TIMESTAMP DEFAULT SYSTIMESTAMP,
    UPDATED_AT TIMESTAMP DEFAULT SYSTIMESTAMP,
    CONSTRAINT FK_CONFIRMATION_HANDOVER FOREIGN KEY (HANDOVER_ID) REFERENCES HANDOVERS(ID),
    CONSTRAINT FK_CONFIRMATION_USER FOREIGN KEY (USER_ID) REFERENCES USERS(ID),
    CONSTRAINT UK_CONFIRMATION_ITEM UNIQUE (HANDOVER_ID, USER_ID, ITEM_ID)
);

-- Tabla HANDOVER_CONTINGENCY_PLANS (planes de contingencia)
CREATE TABLE HANDOVER_CONTINGENCY_PLANS (
    ID VARCHAR2(50) PRIMARY KEY,
    HANDOVER_ID VARCHAR2(50) NOT NULL,
...
-- Tabla HANDOVER_DISCUSSION_MESSAGES (mensajes de discusión)
CREATE TABLE HANDOVER_DISCUSSION_MESSAGES (
    ID VARCHAR2(50) PRIMARY KEY,
    HANDOVER_ID VARCHAR2(50) NOT NULL,
    USER_ID VARCHAR2(255) NOT NULL,
...
-- Tabla HANDOVER_MESSAGE_MENTIONS (menciones en mensajes)
CREATE TABLE HANDOVER_MESSAGE_MENTIONS (
    ID VARCHAR2(50) PRIMARY KEY,
    MESSAGE_ID VARCHAR2(50) NOT NULL,
    MENTIONED_USER_ID VARCHAR2(255) NOT NULL,
    CREATED_AT TIMESTAMP DEFAULT SYSTIMESTAMP,
    CONSTRAINT FK_MENTION_MESSAGE FOREIGN KEY (MESSAGE_ID) REFERENCES HANDOVER_DISCUSSION_MESSAGES(ID),
    CONSTRAINT FK_MENTION_USER FOREIGN KEY (MENTIONED_USER_ID) REFERENCES USERS(ID)
);

-- Tabla HANDOVER_IPASS_TEMPLATES (plantillas I-PASS)
CREATE TABLE HANDOVER_IPASS_TEMPLATES (
    ID VARCHAR2(50) PRIMARY KEY,
...
-- Tabla HANDOVER_SECTION_TEMPLATES (plantillas de secciones)
CREATE TABLE HANDOVER_SECTION_TEMPLATES (
    ID VARCHAR2(50) PRIMARY KEY,
...
CREATE INDEX IDX_CONFIRMATION_HANDOVER ON HANDOVER_CONFIRMATION_CHECKLISTS(HANDOVER_ID);
CREATE INDEX IDX_CONFIRMATION_USER ON HANDOVER_CONFIRMATION_CHECKLISTS(USER_ID);
CREATE INDEX IDX_CONFIRMATION_ITEM ON HANDOVER_CONFIRMATION_CHECKLISTS(ITEM_ID);
CREATE INDEX IDX_CONFIRMATION_CHECKED ON HANDOVER_CONFIRMATION_CHECKLISTS(IS_CHECKED);
CREATE INDEX IDX_CONTINGENCY_HANDOVER ON HANDOVER_CONTINGENCY_PLANS(HANDOVER_ID);
CREATE INDEX IDX_CONTINGENCY_USER ON HANDOVER_CONTINGENCY_PLANS(CREATED_BY);
CREATE INDEX IDX_CONTINGENCY_STATUS ON HANDOVER_CONTINGENCY_PLANS(STATUS);
CREATE INDEX IDX_DISCUSSION_HANDOVER ON HANDOVER_DISCUSSION_MESSAGES(HANDOVER_ID);
CREATE INDEX IDX_DISCUSSION_USER ON HANDOVER_DISCUSSION_MESSAGES(USER_ID);
CREATE INDEX IDX_DISCUSSION_TYPE ON HANDOVER_DISCUSSION_MESSAGES(MESSAGE_TYPE);
CREATE INDEX IDX_DISCUSSION_CREATED ON HANDOVER_DISCUSSION_MESSAGES(CREATED_AT);
CREATE INDEX IDX_MENTION_MESSAGE ON HANDOVER_MESSAGE_MENTIONS(MESSAGE_ID);
CREATE INDEX IDX_MENTION_USER ON HANDOVER_MESSAGE_MENTIONS(MENTIONED_USER_ID);
CREATE INDEX IDX_IPASS_TEMPLATE_ID ON HANDOVER_IPASS_TEMPLATES(TEMPLATE_ID);
CREATE INDEX IDX_IPASS_SECTION ON HANDOVER_IPASS_TEMPLATES(SECTION);
CREATE INDEX IDX_IPASS_ACTIVE ON HANDOVER_IPASS_TEMPLATES(IS_ACTIVE);
CREATE INDEX IDX_SECTION_TEMPLATE_TYPE ON HANDOVER_SECTION_TEMPLATES(SECTION_TYPE);
CREATE INDEX IDX_SECTION_TEMPLATE_DEFAULT ON HANDOVER_SECTION_TEMPLATES(IS_DEFAULT);
...
VALUES ('assign-001', 'user_2demo12345678901234567890123456', 'shift-day', 'pat-001', SYSTIMESTAMP);
...
VALUES ('handover-001', 'assign-001', 'pat-001', 'Active', 'Stable',
        ...
        'Mañana', 'user_2demo12345678901234567890123456', 'user_2demo12345678901234567890123456');
...
VALUES ('participant-001', 'handover-001', 'user_2demo12345678901234567890123456', 'Dr. Johnson', 'Attending Physician', 'active');
...
INSERT INTO HANDOVER_IPASS_TEMPLATES (ID, TEMPLATE_ID, SECTION, TITLE, TEMPLATE_CONTENT, IS_ACTIVE)
VALUES ('template-001', 'illness-update', 'illness', 'Illness Severity Update', 'Patient condition: [condition]\nVital signs: [vitals]\nRecent changes: [changes]\nConcerns: [concerns]', 1);

INSERT INTO HANDOVER_IPASS_TEMPLATES (ID, TEMPLATE_ID, SECTION, TITLE, IS_ACTIVE)
...
INSERT INTO HANDOVER_SECTION_TEMPLATES (ID, SECTION_TYPE, TEMPLATE_NAME, TEMPLATE_CONTENT, IS_DEFAULT)
...
INSERT INTO HANDOVER_CONFIRMATION_CHECKLISTS (ID, HANDOVER_ID, USER_ID, ITEM_ID, ITEM_CATEGORY, ITEM_LABEL, ITEM_DESCRIPTION, IS_REQUIRED, IS_CHECKED)
...
INSERT INTO HANDOVER_DISCUSSION_MESSAGES (ID, HANDOVER_ID, USER_ID, MESSAGE_TEXT, MESSAGE_TYPE, CREATED_AT)
...
INSERT INTO HANDOVER_CONTINGENCY_PLANS (ID, HANDOVER_ID, CONDITION_TEXT, ACTION_TEXT, PRIORITY, STATUS, CREATED_BY, CREATED_AT)
...
UNION ALL
SELECT 'HANDOVER_CONFIRMATION_CHECKLISTS' AS TABLE_NAME, COUNT(*) AS RECORD_COUNT FROM HANDOVER_CONFIRMATION_CHECKLISTS
UNION ALL
SELECT 'HANDOVER_CONTINGENCY_PLANS' AS TABLE_NAME, COUNT(*) AS RECORD_COUNT FROM HANDOVER_CONTINGENCY_PLANS
UNION ALL
SELECT 'HANDOVER_DISCUSSION_MESSAGES' AS TABLE_NAME, COUNT(*) AS RECORD_COUNT FROM HANDOVER_DISCUSSION_MESSAGES
UNION ALL
SELECT 'HANDOVER_MESSAGE_MENTIONS' AS TABLE_NAME, COUNT(*) AS RECORD_COUNT FROM HANDOVER_MESSAGE_MENTIONS
UNION ALL
SELECT 'HANDOVER_IPASS_TEMPLATES' AS TABLE_NAME, COUNT(*) AS RECORD_COUNT FROM HANDOVER_IPASS_TEMPLATES
UNION ALL
SELECT 'HANDOVER_SECTION_TEMPLATES' AS TABLE_NAME, COUNT(*) AS RECORD_COUNT FROM HANDOVER_SECTION_TEMPLATES
UNION ALL
