...
CREATE TABLE PATIENTS (
    ...
    WEIGHT VARCHAR2(20), -- Patient weight in kilograms (kg)
    HEIGHT VARCHAR2(20), -- Patient height in centimeters (cm)
    CREATED_AT TIMESTAMP DEFAULT LOCALTIMESTAMP,
    UPDATED_AT TIMESTAMP DEFAULT LOCALTIMESTAMP,
...
CREATE TABLE HANDOVER_ACTION_ITEMS (
    ...
    PRIORITY VARCHAR2(20) DEFAULT 'medium', -- Priority level: low, medium, high
    DUE_TIME VARCHAR2(10), -- Due time in HH:mm format (24-hour)
    CREATED_BY VARCHAR2(200), -- Name or ID of the user who created this action item
    CREATED_AT TIMESTAMP DEFAULT LOCALTIMESTAMP,
    UPDATED_AT TIMESTAMP DEFAULT LOCALTIMESTAMP,
