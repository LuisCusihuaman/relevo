...
CREATE TABLE HANDOVERS (
    ...
    RESPONSIBLE_PHYSICIAN_ID VARCHAR2(255), -- Doctor responsable
...
ALTER TABLE HANDOVERS ADD CONSTRAINT FK_HANDOVERS_RESP_PHY_ID FOREIGN KEY (RESPONSIBLE_PHYSICIAN_ID) REFERENCES USERS(ID);
...
CREATE TABLE PATIENT_SUMMARIES (
    ...
    SUMMARY_TEXT VARCHAR2(4000) NOT NULL, -- Changed from CLOB for Dapper compatibility
    CREATED_AT TIMESTAMP DEFAULT SYSTIMESTAMP,
    UPDATED_AT TIMESTAMP DEFAULT SYSTIMESTAMP,
...
CREATE TABLE HANDOVER_MESSAGES (
    ...
    USER_ID VARCHAR2(255) NOT NULL,
    USER_NAME VARCHAR2(200) NOT NULL,
    MESSAGE_TEXT VARCHAR2(4000) NOT NULL, -- Changed from CLOB for Dapper compatibility
...
CREATE TABLE HANDOVER_ACTIVITY_LOG (
    ...
    METADATA VARCHAR2(4000), -- JSON with additional activity data (changed from CLOB for Dapper compatibility)
    CREATED_AT TIMESTAMP DEFAULT SYSTIMESTAMP,
...
-- ========================================
-- TABLAS SINGLETON PARA HANDOVERS
-- ========================================

-- Tabla HANDOVER_PATIENT_DATA
CREATE TABLE HANDOVER_PATIENT_DATA (
    ...
    SUMMARY_TEXT VARCHAR2(4000), -- Changed from CLOB for Dapper compatibility
...
-- Tabla HANDOVER_SITUATION_AWARENESS
CREATE TABLE HANDOVER_SITUATION_AWARENESS (
    HANDOVER_ID VARCHAR2(50) PRIMARY KEY REFERENCES HANDOVERS(ID),
    CONTENT VARCHAR2(4000), -- Changed from CLOB for Dapper compatibility
    LAST_EDITED_BY VARCHAR2(255) REFERENCES USERS(ID),
    STATUS VARCHAR2(20) DEFAULT 'draft',
    CREATED_AT TIMESTAMP DEFAULT SYSTIMESTAMP,
    UPDATED_AT TIMESTAMP DEFAULT SYSTIMESTAMP
