...
- [Docker](https://www.docker.com) - Containerization tool for deploying your relevo-frontend app
...
```
git clone git@github.com:RicardoValdovinos/relevo-frontend.git
```
